...
import jp.co.tottori.form.SearchForm;
import jp.co.tottori.mapper.ReserveMapper;
...
public class ReserveService {
	...
	public void reserveCancel(int reserve_id) {
		reserveMapper.reserveCancel(reserve_id);
	}
